...
class DynDetailReply$Type extends MessageType<DynDetailReply> {
    constructor() {
        super("bilibili.app.dynamic.v2.DynDetailReply", [
            { kind: "message", name: "item", no: 1, T: () => DynamicItem }
        ]);
    }
...
class DynDetailReq$Type extends MessageType<DynDetailReq> {
    constructor() {
        super("bilibili.app.dynamic.v2.DynDetailReq", [
            { kind: "scalar", name: "dynamic_id", no: 2, T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
class DynamicItem$Type extends MessageType<DynamicItem> {
    constructor() {
        super("bilibili.app.dynamic.v2.DynamicItem", [
            { kind: "enum", name: "card_type", no: 1, T: () => ["bilibili.app.dynamic.v2.DynamicType", DynamicType] },
            { kind: "enum", name: "item_type", no: 2, T: () => ["bilibili.app.dynamic.v2.DynamicType", DynamicType] },
            { kind: "message", name: "modules", no: 3, repeat: 2 /*RepeatType.UNPACKED*/, T: () => Module },
            { kind: "scalar", name: "has_fold", no: 5, T: 5 /*ScalarType.INT32*/ },
            { kind: "scalar", name: "server_info", no: 6, T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
class Module$Type extends MessageType<Module> {
    constructor() {
        super("bilibili.app.dynamic.v2.Module", [
            { kind: "enum", name: "module_type", no: 1, T: () => ["bilibili.app.dynamic.v2.DynModuleType", DynModuleType] },
            { kind: "message", name: "module_dynamic", no: 5, oneof: "moduleItem", T: () => ModuleDynamic }
        ]);
    }
...
class ModuleDynamic$Type extends MessageType<ModuleDynamic> {
    constructor() {
        super("bilibili.app.dynamic.v2.ModuleDynamic", [
            { kind: "enum", name: "type", no: 1, T: () => ["bilibili.app.dynamic.v2.ModuleDynamicType", ModuleDynamicType] },
            { kind: "message", name: "dyn_archive", no: 2, oneof: "moduleItem", T: () => MdlDynArchive }
        ]);
    }
...
class MdlDynArchive$Type extends MessageType<MdlDynArchive> {
    constructor() {
        super("bilibili.app.dynamic.v2.MdlDynArchive", [
            { kind: "scalar", name: "title", no: 1, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", name: "cover", no: 2, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", name: "uri", no: 3, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", name: "cover_left_text_1", no: 4, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", name: "cover_left_text_2", no: 5, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", name: "cover_left_text_3", no: 6, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", L: 0, name: "avid", no: 7 /*ScalarType.INT64*/, T: 3 /*LongType.BIGINT*/ },
            { kind: "scalar", L: 0, name: "cid", no: 8 /*ScalarType.INT64*/, T: 3 /*LongType.BIGINT*/ },
            { kind: "enum", name: "media_type", no: 9, T: () => ["bilibili.app.dynamic.v2.MediaType", MediaType] },
            { kind: "message", name: "dimension", no: 10, T: () => Dimension },
            { kind: "message", name: "badge", no: 11, repeat: 2 /*RepeatType.UNPACKED*/, T: () => VideoBadge },
            { kind: "scalar", name: "can_play", no: 12, T: 8 /*ScalarType.BOOL*/ },
            { kind: "enum", name: "stype", no: 13, T: () => ["bilibili.app.dynamic.v2.VideoType", VideoType] },
            { kind: "scalar", name: "isPGC", no: 14, T: 8 /*ScalarType.BOOL*/ },
            { kind: "scalar", name: "inlineURL", no: 15, T: 9 /*ScalarType.STRING*/ },
            { jsonName: "EpisodeId", kind: "scalar", L: 0, name: "EpisodeId", no: 16 /*ScalarType.INT64*/, T: 3 /*LongType.BIGINT*/ },
            { jsonName: "SubType", kind: "scalar", name: "SubType", no: 17, T: 5 /*ScalarType.INT32*/ },
            { jsonName: "PgcSeasonId", kind: "scalar", L: 0, name: "PgcSeasonId", no: 18 /*ScalarType.INT64*/, T: 3 /*LongType.BIGINT*/ },
            { kind: "scalar", name: "play_icon", no: 19, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", L: 0, name: "duration", no: 20 /*ScalarType.INT64*/, T: 3 /*LongType.BIGINT*/ },
            { kind: "scalar", name: "jump_url", no: 21, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", name: "is_preview", no: 22, T: 8 /*ScalarType.BOOL*/ },
            { kind: "message", name: "badge_category", no: 23, repeat: 2 /*RepeatType.UNPACKED*/, T: () => VideoBadge },
            { kind: "scalar", name: "is_feature", no: 24, T: 8 /*ScalarType.BOOL*/ },
            { kind: "enum", name: "reserve_type", no: 25, T: () => ["bilibili.app.dynamic.v2.ReserveType", ReserveType] },
            { kind: "scalar", name: "bvid", no: 26, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", name: "view", no: 27, T: 5 /*ScalarType.INT32*/ },
            { kind: "scalar", name: "show_premiere_badge", no: 28, T: 8 /*ScalarType.BOOL*/ },
            { kind: "scalar", name: "premiere_card", no: 29, T: 8 /*ScalarType.BOOL*/ },
            { kind: "scalar", name: "show_progress", no: 30, T: 8 /*ScalarType.BOOL*/ },
            { kind: "scalar", L: 0, name: "part_duration", no: 31 /*ScalarType.INT64*/, T: 3 /*LongType.BIGINT*/ },
            { kind: "scalar", L: 0, name: "part_progress", no: 32 /*ScalarType.INT64*/, T: 3 /*LongType.BIGINT*/ }
        ]);
    }
...
class Dimension$Type extends MessageType<Dimension> {
    constructor() {
        super("bilibili.app.dynamic.v2.Dimension", [
            { kind: "scalar", L: 0, name: "height", no: 1 /*ScalarType.INT64*/, T: 3 /*LongType.BIGINT*/ },
            { kind: "scalar", L: 0, name: "width", no: 2 /*ScalarType.INT64*/, T: 3 /*LongType.BIGINT*/ },
            { kind: "scalar", L: 0, name: "rotate", no: 3 /*ScalarType.INT64*/, T: 3 /*LongType.BIGINT*/ }
        ]);
    }
...
class VideoBadge$Type extends MessageType<VideoBadge> {
    constructor() {
        super("bilibili.app.dynamic.v2.VideoBadge", [
            { kind: "scalar", name: "text", no: 1, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", name: "text_color", no: 2, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", name: "text_color_night", no: 3, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", name: "bg_color", no: 4, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", name: "bg_color_night", no: 5, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", name: "border_color", no: 6, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", name: "border_color_night", no: 7, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", name: "bg_style", no: 8, T: 5 /*ScalarType.INT32*/ },
            { kind: "scalar", name: "bg_alpha", no: 9, T: 5 /*ScalarType.INT32*/ },
            { kind: "scalar", name: "bg_alpha_night", no: 10, T: 5 /*ScalarType.INT32*/ }
        ]);
    }
...
class Device$Type extends MessageType<Device> {
    constructor() {
        super("bilibili.app.dynamic.v2.Device", [
            { kind: "scalar", name: "app_id", no: 1, T: 5 /*ScalarType.INT32*/ },
            { kind: "scalar", name: "build", no: 2, T: 5 /*ScalarType.INT32*/ },
            { kind: "scalar", name: "buvid", no: 3, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", name: "mobi_app", no: 4, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", name: "platform", no: 5, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", name: "device", no: 6, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", name: "channel", no: 7, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", name: "brand", no: 8, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", name: "model", no: 9, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", name: "osver", no: 10, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", name: "fp_local", no: 11, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", name: "fp_remote", no: 12, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", name: "version_name", no: 13, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", name: "fp", no: 14, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", L: 0, name: "fts", no: 15 /*ScalarType.INT64*/, T: 3 /*LongType.BIGINT*/ }
        ]);
    }
...
class Metadata$Type extends MessageType<Metadata> {
    constructor() {
        super("bilibili.app.dynamic.v2.Metadata", [
            { kind: "scalar", name: "access_key", no: 1, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", name: "mobi_app", no: 2, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", name: "device", no: 3, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", name: "build", no: 4, T: 5 /*ScalarType.INT32*/ },
            { kind: "scalar", name: "channel", no: 5, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", name: "buvid", no: 6, T: 9 /*ScalarType.STRING*/ },
            { kind: "scalar", name: "platform", no: 7, T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
export const Dynamic = new ServiceType("bilibili.app.dynamic.v2.Dynamic", [
    { I: DynDetailReq, name: "DynDetail", O: DynDetailReply, options: {} }
]);
